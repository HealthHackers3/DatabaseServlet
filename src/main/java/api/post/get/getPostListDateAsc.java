...
public class getPostListDateAsc implements apiCommandHandler {
    private final String[] commands;
    public getPostListDateAsc(String[] commands){
    ...
    public void handle(HttpServletRequest req, HttpServletResponse resp, Statement s) throws Exception {
        ...
        s.execute("SELECT post_id FROM lposts ORDER BY upload_date ASC");
