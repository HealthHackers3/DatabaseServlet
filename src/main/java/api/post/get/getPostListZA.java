...
public class getPostListZA implements apiCommandHandler {
    private final String[] commands;
    public getPostListZA(String[] commands){
    ...
    public void handle(HttpServletRequest req, HttpServletResponse resp, Statement s) throws Exception {
        ...
        s.execute("SELECT post_id FROM lposts ORDER BY post_name DESC");
